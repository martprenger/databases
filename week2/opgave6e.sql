...
insert into gebruiker (naam, email, bankrekening)
...
insert into abonoment (type, betalende_gebruiker_ID, aantal_gebruikers)
values ('Premium', 1, 1),
       ('Family', 2, 4),
       ('Student', 3, 1),
       ('Premium', 4, 1),
...
insert into genre (naam, description)
values ('Pop', 'Popular music with catchy tunes'),
...
insert into album (naam, type, release_date, genre_ID)
values ('÷ (Divide)', 'Studio Album', '2017-03-03', 1),
...
insert into track (naam, track_nummer, duur, is_playable)
values ('Shape of You', 1, 235, true),
...
insert into album_artiest (album_ID, artiest_ID)
values (1, 1),
       (2, 2),
       (3, 3),
       (4, 4),
...
insert into track_artiest (track_ID, artiest_ID)
values (1, 1),
       (2, 2),
       (3, 3),
       (4, 4),
...
insert into playlist (naam, omschrijving, eigenaar_ID, genre_ID, is_public)
values ('Top Hits', 'The best of the charts', 1, 1, true),
...
insert into speel_geschiedenis (gebruiker_ID, track_ID, speel_lengte, speel_datum)
values (1, 1, 235, '2024-03-01'),
       (2, 2, 255, '2024-03-02'),
       (3, 3, 198, '2024-03-03'),
       (4, 4, 398, '2024-03-04'),
       (5, 5, 369, '2024-03-05'),
...
insert into library (gebruiker_ID, link_ID, type)
values (1, 1, 'Track'),
       (1, 2, 'Track'),
       (2, 3, 'Track'),
       (3, 4, 'Album'),
